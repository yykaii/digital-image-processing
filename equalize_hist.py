...
if __name__ == '__main__':
    src = cv2.imread('c1_contrast.jpg')#原始图像
    ...
    src1 = Image.open('c1_contrast1.jpg')  # imread的图像为数组，image其自带的open方法无法处理，mode不对应，open返回一个pil对象
