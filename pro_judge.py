...
def rotate90(image, file):
    ...
    #保存投影图片
    cv2.imwrite('rotation_test/pro_judge/90_wrong_projectionimage/' + str(file), newimg)
    ...
    log = open('rotation_test/pro_judge/90_result_log.txt', 'a+')
    log.write(str(file)+':'+'\n')
...
def rotate180(image, file):
    ...
    #保存投影图片
    cv2.imwrite('rotation_test/pro_judge/180_wrong_projectionimage/' + str(file), newimg)
    ...
    log = open('rotation_test/pro_judge/180_result_log.txt', 'a+')
    log.write(str(file) + ':' + '\n')
    log.write('angle:' + str(ang) + '\n')
    log.write('start:' + str(start) + '\n')
    log.write('quater:' + str(quater) + '\n')
...
if __name__ == '__main__':
    ...
    for file in file_names:
        # file1 = open('rotation_test/pro_judge/90_result.txt', 'a+')
        file1 = open('rotation_test/pro_judge/180_result.txt', 'a+')
